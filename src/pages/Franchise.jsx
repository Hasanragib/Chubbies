...
export default function Franchise() {
  const { brand, contact, franchise, seo } = useSite();
        ...
        <div className="container">
          <div className={styles.galleryIntro}>
            ...
            <p className={styles.galleryText}>
              Every franchisee gets the exact same cart — LED-lit canopy, twin
              bamboo steamers, branded panels, and signage, all built in before
              it reaches you.
            </p>
          </div>
        ...
        <div className={`container ${styles.ctaGrid}`}>
          <div>
            ...
            <p className={styles.ctaText}>
              ...
              business days. For a faster response, DM {contact.instagramHandle}{" "}
              or call {contact.phone} / {contact.phone2}.
            </p>
          </div>
